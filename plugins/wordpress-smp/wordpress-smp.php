<?php
/*
Plugin Name: WooCommerce Customer Control Centre (WooCommerce-CCC)
Description: Extends the WordPress REST API for user and WooCommerce management.
Version: 1.0.0
Author: Your Name
*/
...
if ( ! class_exists( 'JWT' ) ) {
    ...
    require_once plugin_dir_path( __FILE__ ) . 'includes/BeforeValidException.php';
    require_once plugin_dir_path( __FILE__ ) . 'includes/ExpiredException.php';
    require_once plugin_dir_path( __FILE__ ) . 'includes/SignatureInvalidException.php';
}

class WooCommerce_CCC_API {
